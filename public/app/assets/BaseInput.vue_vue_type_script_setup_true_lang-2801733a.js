...
`,[v("splitor",`
 ...
 `),G("checked",{color:"var(--n-button-text-color-hover)"})]),k("focus",[I("&:not(:active)",[v("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),k("checked",`
