...
const lightThemeVars: PublicApp.ThemeVars = {
  fontFamily: "'Sakkal Majalla', system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif",
...
const darkThemeVars: PublicApp.ThemeVars = {
  fontFamily: "'Sakkal Majalla', Times New Roman, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
  fontFamilyMono: "v-mono, SFMono-Regular, Menlo, Consolas, Courier, monospace",
  fontWeight: "400",
  fontWeightStrong: "700",
  cubicBezierEaseInOut: "cubic-bezier(.4, 0, .2, 1)",
